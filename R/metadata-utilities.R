...
#'
#' @return Currently, a `data.frame` is returned a row for each match, and a column for each *named* group within a match.  For the `retrieve_checkbox_choices()` function, the columns will be.
