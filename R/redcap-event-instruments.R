...
#' project.  Required.
#' @param arm A character string of arms to retrieve.
...
#' REDCapR::redcap_event_instruments(redcap_uri=uri, token=token_2, arm = c("1", "2"))$data
#' REDCapR::redcap_event_instruments(redcap_uri=uri, token=token_2, arm = "2")$data
#'
