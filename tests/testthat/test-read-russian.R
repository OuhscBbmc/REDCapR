...
test_that("Russian Recruit", {
  ...
  # expect_identical(d$recruitment_other[1], expected_single)
  # expect_identical(d$recruitment_other, expected_multiple)
})
...
#   expect_identical(d$recruitment_other, expected)
# })
