...
test_that("Smoke Test", {
  ...
  expected_status_message <- "3 records and 16 columns were read from REDCap in \\d+\\.\\d{2} seconds."
  ...
  expect_match(returned_object$status_message, regexp=expected_status_message)
