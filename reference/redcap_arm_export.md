...
#> The list of arms was retrieved from the REDCap project in 0.5 seconds. The http status code was 200.
result_1$has_arms
#> [1] TRUE
result_1$data
#> # A tibble: 3 × 2
...
#> A 'classic' REDCap project has no arms.  Retrieved in 0.4 seconds. The http status code was 400.
result_2$has_arms
#> [1] FALSE
result_2$data
#> # A tibble: 0 × 2
