...
#> [1] "/var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instruments-all-records-all8e39da34850.pdf"
result_1   <- REDCapR::redcap_instrument_download(
  file_name     = full_name,
  redcap_uri    = uri,
  token         = token
)
#> Preparing to download the file `/var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instruments-all-records-all8e39da34850.pdf`.
#> text/html; charset=UTF-8 successfully downloaded in 0.3 seconds, and saved as /var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instruments-all-records-all8e39da34850.pdf.
base::unlink(full_name)

(full_name <- base::tempfile(pattern="instruments-all-record-1-", fileext = ".pdf"))
#> [1] "/var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instruments-all-record-1-8e395ae0832e.pdf"
...
#> Preparing to download the file `/var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instruments-all-record-1-8e395ae0832e.pdf`.
#> text/html; charset=UTF-8 successfully downloaded in 0.3 seconds, and saved as /var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instruments-all-record-1-8e395ae0832e.pdf.
base::unlink(full_name)
(full_name <- base::tempfile(pattern="instrument-1-record-1-", fileext=".pdf"))
#> [1] "/var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instrument-1-record-1-8e3949c46f9e.pdf"
...
#> Preparing to download the file `/var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instrument-1-record-1-8e3949c46f9e.pdf`.
#> text/html; charset=UTF-8 successfully downloaded in 0.3 seconds, and saved as /var/folders/8j/sfr9qqcj73j4p6nhwcfpr0th0000gn/T//Rtmpike5G1/instrument-1-record-1-8e3949c46f9e.pdf.
base::unlink(full_name)
# }
```
