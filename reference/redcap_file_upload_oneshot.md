...
#> file uploaded to REDCap in 0.4 seconds.
#> $success
#> [1] TRUE
#> 
#> $status_code
...
#> 
#> $outcome_message
#> [1] "file uploaded to REDCap in 0.4 seconds."
#> 
