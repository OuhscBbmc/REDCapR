structure(list(project_id = 3748L, project_title = "REDCapR Vignette: Writing Repeating Measures", 
    creation_time = structure(1685741890, class = c("POSIXct", 
    ...
    project_notes = "Accompanies R/Medicine 2023 talk.  See also https://github.com/RaymondBalise/r_med_redcap_2023_public", 
    custom_record_label = NA_character_, secondary_unique_field = NA_character_, 
    is_longitudinal = FALSE, has_repeating_instruments_or_events = TRUE, 
