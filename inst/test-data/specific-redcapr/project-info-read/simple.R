structure(list(project_id = 33L, project_title = "REDCapR: simple", 
    ...
    project_pi_lastname = NA_character_, project_pi_email = NA_character_, 
    display_today_now_button = TRUE, missing_data_codes = NA_character_, 
    external_modules = "redcap_entity", bypass_branching_erase_field_prompt = "0"), class = c("spec_tbl_df", 
"tbl_df", "tbl", "data.frame"), row.names = c(NA, -1L), spec = structure(list(
    cols = list(project_id = structure(list(), class = c("collector_integer", 
    ...
    "collector")), project_pi_email = structure(list(), class = c("collector_character", 
