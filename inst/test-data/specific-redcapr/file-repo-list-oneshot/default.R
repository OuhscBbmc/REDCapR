...
), role = c(NA, NA, NA, NA, NA, NA), dag = c(NA, NA, NA, NA, 
NA, NA)), class = c("spec_tbl_df", "tbl_df", "tbl", "data.frame"
    ...
    "collector")), role = structure(list(), class = c("collector_logical", 
    "collector")), dag = structure(list(), class = c("collector_logical", 
