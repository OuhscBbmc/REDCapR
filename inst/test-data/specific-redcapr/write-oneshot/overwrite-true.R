...
"Nutmouse", "Wood", "DAG", "Walker"), address = c(NA, NA, NA, 
NA, NA), telephone = c(NA, NA, NA, NA, NA), email = c("nutty@mouse.com", 
"tummy@mouse.comm", "mw@mwood.net", "peroxide@blonde.com", "left@hippocket.com"
    ...
    "collector")), telephone = structure(list(), class = c("collector_logical", 
