structure(list(username = "unittestphifree", firstname = "Unit Test", 
    ...
    data_access_group_label = NA, design = FALSE, alerts = 0, 
    user_rights = 1L, data_access_groups = TRUE, reports = FALSE, 
    stats_and_charts = FALSE, manage_survey_participants = FALSE, 
