...
-5375), class = "Date"), `Age (years)` = c(11, 11, 80, 61, 59
    ...
    0, 1, NA, 0), `Complete?_2` = c(2, 0, 2, 2, 2)), class = "data.frame", row.names = c(NA, 
-5L), spec = structure(list(cols = list(`Study ID` = structure(list(), class = c("collector_double", 
...
"collector")), `Date of birth` = structure(list(format = ""), class = c("collector_date", 
