...
--
CREATE TABLE [RedcapPrivate].[tbl_credential](
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_tbl_credential_unique] ON [RedcapPrivate].[tbl_credential]
(
	[instance] ASC,
	[project_id] ASC,
	[username] ASC
...
BEGIN
   ...
   SELECT username, project_id, token, redcap_uri FROM [RedcapPrivate].[tbl_credential]
