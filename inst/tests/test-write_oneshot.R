...
###########
# source(file.path(devtools::inst(name="REDCapR"), "tests/project_simple.R")
start_clean <- function( ) {
  expect_message(
  ...
  expect_message(
    populate_result <- REDCapR:::populate_project_simple(),
...
test_that("Smoke Test", {  
  start_clean_result <- start_clean()    
...
test_that("Write One Shot -Update", {  
  start_clean_result <- start_clean()    
  project <- start_clean_result$redcap_project
