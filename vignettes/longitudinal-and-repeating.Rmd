...
REDCap and EMR databases have an "observation" t, store observations in their underlying table.  This table is a simplification of the `redcap_data` table, which is the heart of the database.
...
The tidy datasets represented in Tables 1, 3a, and 3b can be obtained by calling REDCapR three times --one call per table.  Using the `forms` parameter, pass "demographics" to get Table 1, "blood_pressure" to get Table 3a, and "laboratory" to get Table 3b.
