...
**Table 5: mismashed grain** is how the points are returned from REDCap if you request the data in a single call.
...
REDCapTidieR's initial motivation is to facilitate longitudinal analyses
