...
1. **Do you have an account for the *server*?**  This can be verified in the `Browse Users` section of the server's `Control Center`.  
    ...
    * If you're a REDCap admin, put yourself in the user's postion --does the user have an account?
...
1. **Can you export from an example project?** This is the same fake data hosted by the [OUHSC BBMC](http://ouhsc.edu/bbmc/) as in the previous section.
...
1. **Can you export their data dictiontary?** Sometimes the problem exists within the metadata/dictionary, instead of the actual data values.  Verify the structure and content of this specific project is interpretable by your local environment.
...
1. **Can you import the *entire* project?**

1. **Can you import a *subset* of the project?**
